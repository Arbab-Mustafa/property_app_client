...
`;
  ...
  const beforeImages = [
    ...
    {
      src: "/assets/case-study-before-richard/2.jpg",
      alt: "Before - Property View 2",
    },
    {
      src: "/assets/case-study-before-richard/3.jpg",
      alt: "Before - Property View 3",
    },
    {
      src: "/assets/case-study-before-richard/4.jpg",
      alt: "Before - Property View 4",
    },
    {
      src: "/assets/case-study-before-richard/5.jpg",
      alt: "Before - Property View 5",
    },
    {
      src: "/assets/case-study-before-richard/6.jpg",
      alt: "Before - Property View 6",
    },
    {
      src: "/assets/case-study-before-richard/7.jpg",
      alt: "Before - Property View 7",
    },
    {
      src: "/assets/case-study-before-richard/8.jpg",
      alt: "Before - Property View 8",
    },
    {
      src: "/assets/case-study-before-richard/9.jpg",
  ...
  const afterImages = [
    ...
    {
      src: "/assets/case-study-after-richard/2.jpg",
      alt: "After - Property View 2",
    },
    {
      src: "/assets/case-study-after-richard/3.jpg",
      alt: "After - Property View 3",
    },
    {
      src: "/assets/case-study-after-richard/4.jpg",
      alt: "After - Property View 4",
    },
    {
      src: "/assets/case-study-after-richard/5.jpg",
      alt: "After - Property View 5",
    },
    {
      src: "/assets/case-study-after-richard/6.jpg",
      alt: "After - Property View 6",
    },
    {
      src: "/assets/case-study-after-richard/7.jpg",
      alt: "After - Property View 7",
    },
    {
      src: "/assets/case-study-after-richard/8.jpg",
      alt: "After - Property View 8",
    },
    {
      src: "/assets/case-study-after-richard/9.jpg",
  ...
  return (
    <>
      ...
      <Helmet>
        <title>
          2-Bed Social Housing – North East Lincolnshire Case Study | 33% ROI
          Investment Success
        </title>
        <meta
          name="description"
          content="Detailed case study of our 2-bed social housing project in North East Lincolnshire showing 33.13% ROI through light modernisation and social housing strategy."
        />
        <meta
          property="og:title"
          content="2-Bed Social Housing – North East Lincolnshire Case Study | 33% ROI Investment Success"
        />
        <meta
      ...
      <section className="bg-primary text-white py-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6 pt-20">
            2-Bed Social Housing
            <br />
            North East Lincolnshire
          </h1>
          <p className="text-xl md:text-2xl max-w-4xl mx-auto">
            A highly successful social housing investment requiring only light
            modernisation, delivering exceptional returns through strategic
            positioning and fast execution.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            ...
            <div className="bg-gray-100 rounded-lg overflow-hidden shadow-lg">
              ...
              <div className="p-4 text-center">
                ...
                <p className="text-sm text-gray-500 mt-2">
                  Light modernisation required. Paint, carpets, and boundary
                  work needed for social housing compliance.
                </p>
              </div>
            </div>
            ...
            <div className="bg-gray-100 rounded-lg overflow-hidden shadow-lg">
              ...
              <div className="p-4 text-center">
                <p className="text-gray-600 font-medium">
                  Modernised & Compliant
                </p>
                <p className="text-sm text-gray-500 mt-2">
                  Fresh paint, new carpets, cooker installed. All compliance
                  checks completed for 5-year social housing tenancy.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-gray-50 rounded-lg p-8 shadow-lg">
                ...
                {financialBreakdown.map((item, index) => (
                  <div
                    ...
                    className={`flex justify-between items-center p-4 rounded-lg ${
                      item.label === "Acquisition Cost" ||
                      item.label === "Annual Rental Income"
              ...
              <div className="mt-8 p-6 bg-green-100 rounded-lg text-center">
                ...
                <p className="text-green-700">
                  5-year social housing tenancy secured with registered provider
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-gray-500 italic">
                  For illustrative purposes only. Based on UK averages as of
                  2025.
                </p>
              </div>
            </div>
                ...
                <div>
                  ...
                  <ul className="space-y-3">
                    ...
                    <li className="flex items-start">
                      ...
                      <span>
                        Garden boundaries secured and compliance checks
                      </span>
                    </li>
                  </ul>
                </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <blockquote className="text-2xl md:text-3xl font-medium mb-6 italic">
              "This deal showed me how powerful social housing can be - minimal
              work, maximum returns, and complete peace of mind."
            </blockquote>
